  ...
  const products = [
    {
      ...
      images: JSON.stringify(['/uploads/products/frying-pan-set.jpg']),
    ...
    },
    {
      ...
      description: 'Compact 20L microwave oven with digital controls and multiple cooking modes',
      shortDescription: '20L digital microwave oven',
      sku: 'ELE-MIC-001',
      price: 8500,
      comparePrice: 10000,
      categoryId: createdCategories[6].id,
      brandId: createdBrands[1].id,
      images: JSON.stringify(['/uploads/products/microwave-oven.jpg']),
      tags: JSON.stringify(['electronics', 'kitchen', 'microwave']),
      stock: 25,
      isFeatured: true,
    },
    {
      ...
      brandId: createdBrands[5].id,
      images: JSON.stringify(['/uploads/products/all-purpose-cleaner.jpg']),
    ...
    },
    {
      ...
      brandId: createdBrands[5].id,
      images: JSON.stringify(['/uploads/products/storage-baskets.jpg']),
    ...
    },
    {
      ...
      brandId: createdBrands[5].id,
      images: JSON.stringify(['/uploads/products/towel-set.jpg']),
