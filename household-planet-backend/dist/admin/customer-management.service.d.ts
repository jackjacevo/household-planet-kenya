...
export declare class CustomerManagementService {
    ...
    segmentCustomers(criteria: any): Promise<({
        orders: {
            createdAt: Date;
            total: number;
        }[];
    ...
    removeCustomerTag(customerId: string, tag: string): Promise<{
        message: string;
    }>;
    manageLoyaltyPoints(customerId: string, points: number, type: string, description: string): Promise<{
        transaction: {
            id: string;
            description: string;
            createdAt: Date;
    ...
    addTicketReply(ticketId: string, message: string, isStaff?: boolean): Promise<{
        id: string;
        createdAt: Date;
        message: string;
        ticketId: string;
    ...
    verifyAddress(customerId: string, addressId: string): Promise<{
        isValid: string;
        address: {
            phone: string;
            id: string;
    ...
    getCustomerCommunicationLog(customerId: string): Promise<({
        type: string;
        id: string;
        subject: string;
        status: string;
