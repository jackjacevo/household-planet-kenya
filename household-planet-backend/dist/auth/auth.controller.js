...
let AuthController = class AuthController {
    ...
    sendPhoneVerification(sendPhoneVerificationDto) {
        return this.authService.sendPhoneVerification(sendPhoneVerificationDto);
    }
    verifyPhone(verifyPhoneDto) {
...
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Post)('send-phone-verification'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [verify_phone_dto_1.SendPhoneVerificationDto]),
    __metadata("design:returntype", void 0)
