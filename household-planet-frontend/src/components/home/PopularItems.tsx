...
export function PopularItems() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const data = await api.getProducts({ limit: 4, sortBy: 'totalReviews', sortOrder: 'desc' }) as any;
    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Popular Items</h2>
        ...
        {products.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Popular products will appear here based on customer reviews.</p>
          </div>
        ) : (
