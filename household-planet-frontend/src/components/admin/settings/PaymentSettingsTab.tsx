    ...
    <div className="space-y-6">
      <div className="flex items-center mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">Configure payment methods and pricing settings</p>
        </div>
      </div>

      {/* Pricing Settings */}
      <div className="bg-gray-50 p-4 rounded-lg">
        <h3 className="text-md font-medium text-gray-900 mb-4">Pricing & Fees</h3>
      ...
      <div className="bg-green-50 p-4 rounded-lg">
        <h3 className="text-md font-medium text-gray-900 mb-4">M-Pesa Configuration</h3>
