...
export default function CustomerManagement() {
  ...
  const addTag = async () => {
    ...
    try {
      const response = await fetch(`/api/customers/${selectedCustomer.customerProfile.id}/tags`, {
        method: 'POST',
        headers: {
  ...
  const removeTag = async (tag: string) => {
    ...
    try {
      const response = await fetch(`/api/customers/${selectedCustomer.customerProfile.id}/tags/${encodeURIComponent(tag)}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  const sendCommunication = async () => {
    ...
    try {
      const response = await fetch(`/api/customers/${selectedCustomer.customerProfile.id}/communications`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
