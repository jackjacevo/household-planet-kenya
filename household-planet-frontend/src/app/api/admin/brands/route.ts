...
export async function GET(request: NextRequest) {
  try {
    ...
    const backendUrl = `${BACKEND_URL}/api/admin/brands?${searchParams.toString()}`;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const backendUrl = `${BACKEND_URL}/api/admin/brands`;
    ...
    console.error('Admin brands POST API error:', error);
    return NextResponse.json(
